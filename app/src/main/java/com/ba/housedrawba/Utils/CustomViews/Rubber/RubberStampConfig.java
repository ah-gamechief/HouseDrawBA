...
import static com.ba.housedrawba.Utils.CustomViews.Rubber.RubberStampPosition.CENTER;
...
public class RubberStampConfig {
    ...
    public void setmBaseBitmap(Bitmap mBaseBitmap) {
        this.mBaseBitmap = mBaseBitmap;
    }

    public void setmBaseDrawable(int mBaseDrawable) {
        this.mBaseDrawable = mBaseDrawable;
    }
    ...
    public void setmTextBackgroundColor(int mTextBackgroundColor) {
        this.mTextBackgroundColor = mTextBackgroundColor;
    }

    public void setmTypeFacePath(String mTypeFacePath) {
        this.mTypeFacePath = mTypeFacePath;
    }

    public void setmRubberStampPosition(RubberStampPosition mRubberStampPosition) {
        this.mRubberStampPosition = mRubberStampPosition;
    }

    public void setmRubberStampString(String mRubberStampString) {
        this.mRubberStampString = mRubberStampString;
    }

    public void setmRubberStampBitmap(Bitmap mRubberStampBitmap) {
        this.mRubberStampBitmap = mRubberStampBitmap;
    }

    public void setmAplha(int mAplha) {
        this.mAplha = mAplha;
    }

    public void setmTextShader(Shader mTextShader) {
        this.mTextShader = mTextShader;
    }
    ...
    public void setmTextShadowBlurRadius(float mTextShadowBlurRadius) {
        this.mTextShadowBlurRadius = mTextShadowBlurRadius;
    }

    public void setmTextShadowXOffset(float mTextShadowXOffset) {
        this.mTextShadowXOffset = mTextShadowXOffset;
    }

    public void setmTextShadowYOffset(float mTextShadowYOffset) {
        this.mTextShadowYOffset = mTextShadowYOffset;
    }

    public void setmTextShadowColor(int mTextShadowColor) {
        this.mTextShadowColor = mTextShadowColor;
    }

    public void setmXMargin(int mXMargin) {
        this.mXMargin = mXMargin;
    }

    public void setmYMargin(int mYMargin) {
