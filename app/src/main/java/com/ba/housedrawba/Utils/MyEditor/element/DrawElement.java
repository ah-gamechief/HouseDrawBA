...
import com.ba.housedrawba.Utils.MyEditor.ConfigManager;
...
import com.ba.housedrawba.Utils.MyEditor.PaintingBehavior;
import com.ba.housedrawba.Utils.MyEditor.core.CiPaint;
import com.ba.housedrawba.Utils.MyEditor.element.behavior.Movable;
import com.ba.housedrawba.Utils.MyEditor.element.behavior.Resizable;
import com.ba.housedrawba.Utils.MyEditor.element.behavior.ResizingDirection;
import com.ba.housedrawba.Utils.MyEditor.element.behavior.Rotatable;
import com.ba.housedrawba.Utils.MyEditor.element.behavior.Selectable;
import com.ba.housedrawba.Utils.MyEditor.element.behavior.Skewable;
import com.ba.housedrawba.Utils.MyEditor.exception.DrawingBoardNotFoundException;
import com.ba.housedrawba.Utils.MyEditor.persistence.ConvertUtils;
import com.ba.housedrawba.Utils.MyEditor.persistence.PersistenceException;
import com.ba.housedrawba.Utils.MyEditor.utils.DrawUtils;
import com.ba.housedrawba.Utils.MyEditor.utils.ShapeUtils;
    ...
    public boolean hitTestForSelection(float x, float y) {
        ...
        if (getBoundingBox() != null) {
            ...
            if (path.isRect(box)) {
                ...
                Rect touchSquare = DrawUtils.createTouchSquare(drawingView.getContext(),
