package com.ba.housedrawba.Utils.CustomViews.CustomFab;
...
public class FloatingActionsMenu extends ViewGroup {
    ...
    public void setIconDrawable(Context context,int resId){
        this.iconDrawable =ResourcesCompat.getDrawable(getContext().getResources(),resId, context.getTheme());
//        createAddButton(context);
        invalidate();
    }
...
//                Drawable myFabSrc = ResourcesCompat.getDrawable(getContext().getResources(),R.drawable.layers_icon, context.getTheme());

                if (iconDrawable==null){
                    iconDrawable = ResourcesCompat.getDrawable(getContext().getResources(),R.drawable.layers_icon, context.getTheme());
                }

                final RotatingDrawable rotatingDrawable = new RotatingDrawable(iconDrawable);
    ...
    public void addButton(FloatingActionButton button) {
        ...
        mButtonsCount++;
        if (mLabelsStyle != 0) createLabels();
    }
