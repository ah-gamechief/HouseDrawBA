package com.ba.housedrawba.Utils.CustomViews;
...
public class CustomImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private static final float DEFAULT_BOARDER_STROKE = 0;
    int borderRadius = 35;
    ...
    private Bitmap getRoundedCroppedBitmap(Bitmap bitmap, int radius) {
        ...
        canvas.drawRoundRect(new RectF(0, 0, finalBitmap.getWidth(), finalBitmap.getHeight()), borderRadius, borderRadius, paint);
        ...
        if (!removeBorder) {
            canvas.drawRoundRect(new RectF(0, 0, finalBitmap.getWidth(), finalBitmap.getHeight()), borderRadius, borderRadius, getBorderPaint());
        }
